 ...
 */
public class HC450Executor
implements Executor
{
    private final static Logger log = Logger.getLogger(HC450Executor.class.getSimpleName());

    private final HttpClient httpClient;
    private final Serializer serializer;

    public HC450Executor(HttpClient httpClient, Serializer serializer)
    {
    ...
    throws IOException
    {
        ...
        ConnectionCloser connectionCloser = new HC450ConnectionCloser(request);
